...
function loadReceived(){
    ...
    $.ajax({
        url :'/shipping/sea/load_received?page='+page,
        type:'POST',
        contentType: false,
        processData: false,
        async:true,
...
function editReseved(id_){
    ...
    $.ajax({
        url :'/shipping/sea/edit_received',
        type:'POST',
        contentType: false,
        processData: false,
        async:true,
...
function save_received(){
    ...
    if(ok){
        ...
        setTimeout(() => {
            $.ajax({
                url :'/shipping/sea/save_received',
                type:'POST',
                processData: false,
                contentType: false,
                async:true,
