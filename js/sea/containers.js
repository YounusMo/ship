...
function loadcontainers(){
    ...
    $.ajax({
        url :'/shipping/sea/load_containers?page='+page,
        type:'POST',
        contentType: false,
        processData: false,
        async:true,
...
//---------------------------------------------------------------------------------------
function upadteStatusCustomContainer(id , status){
    ask(langContent['Do you want to complete ?'],function(){
        var formData = new FormData();
        ...
        $.ajax({
            url :'/shipping/sea/change_status_custom_container',
            type:'POST',
            contentType: false,
            processData: false,
            async:true,
            ...
            success:e=>{
                ...
                if(e.type === 'balance_err_supplier'){
...
function loadCanceledcontainers(){
    ...
    $.ajax({
        url :'/shipping/sea/load_canceled_containers?page='+page,
        type:'POST',
        contentType: false,
        processData: false,
        async:true,
...
function cancelContainer(id){
    ask(langContent['Do you want to cancel ?'],function(){
        ...
        $.ajax({
            url :'/shipping/sea/cancel_container',
            type:'POST',
            contentType: false,
            processData: false,
            async:true,
...
function change_status(id,val){
    ...
    $.ajax({
        url :'/shipping/sea/change_status',
        type:'POST',
        contentType: false,
        processData: false,
        async:true,
...
function printContainer(id){
    ...
    $.ajax({
        url :'/shipping/sea/print_container',
        type:'POST',
        contentType: false,
        processData: false,
        async:true,
...
sys_selector('#new_custom_container .branch_selector2')
//---------------------------------------------------------------------------------------
$(`#new_custom_container .inp[data-name="payment"] , #new_custom_container .inp[data-name="payment_supplier"]`).on('change',function(){
    ...
    if(payment_supplier === 'pay2'){
        $(`#new_custom_container .branch_selector2 .sys_selector button`).attr('disabled',false)
    }else{
        $(`#new_custom_container .branch_selector2 .sys_selector button`).attr('disabled',true)
        $(`#new_custom_container .inp[data-name="branch2"]`).val('')
        $(`#new_custom_container .branch_selector2 .sys_selector button`).text(langContent['Select'])
    }
})
//---------------------------------------------------------------------------------------
...
$('.complete_custom_btn').on('click',function(){
    ...
    $.ajax({
        url :'/shipping/sea/withdraw_custom_broker',
        type:'POST',
        contentType: false,
        processData: false,
        async:true,
...
function create_custom_container(){
    ...
    let branch2    = $(`#new_custom_container .inp[data-name="branch2"]`).val()
    let notes    = $(`#new_custom_container .inp[data-name="notes"]`).val()
    ...
    if(payment_supplier === 'pay2'){
        if(!payment_supplier || !supplier || !branch2){
            showErr(langContent['Insert required data']) 
            return;
        }
    }
    ...
    $.ajax({
        url :'/shipping/sea/new_custom_container',
        type:'POST',
        contentType: false,
        processData: false,
        async:true,
...
function showContainer(id){
    ...
    console.log(id)
    $.ajax({
        url :'/shipping/sea/show_custom_container',
        type:'POST',
        contentType: false,
        processData: false,
        async:true,
...
function showPackingList(id,title){
    ...
    $.ajax({
        url :'/shipping/sea/print_packing_list',
        type:'POST',
        contentType: false,
        processData: false,
        async:true,
