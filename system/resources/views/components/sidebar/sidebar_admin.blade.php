...
<div class="sidebar hide-scrollbar">
    ...
    <ul>
        ...
        {{-- Removed from sidebar per operator request:
             Revenue (/profits), Matching, Old Balance Archive.
             Routes still exist but are no longer surfaced in the nav. --}}
        ...
        <li class="{{$page === 'sourcing_requests' ? 'active' : ''}}">
        ...
        <li class="{{$page === 'sourcing_proformas' || $page === 'sourcing' || $page === 'sourcing_commissions' ? 'active' : ''}}">
