...
<div style="direction:{{Auth::guard('client')->user()->lang === 'ar' ? 'rtl' : 'ltr'}};text-align:center">
    
    <div class="d-none">
        @if (env('SHOW_COMPANY_DATA_IN_CLIENT_ALL_REPORT'))
            <div style="display:flex;align-items-center;justify-content:space-between;text-align:{{Auth::guard('client')->user()->lang === 'ar' ? 'right' : 'left'}};direction:{{Auth::guard('client')->user()->lang === 'ar' ? 'rtl' : 'ltr'}}">
