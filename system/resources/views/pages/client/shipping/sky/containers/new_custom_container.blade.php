    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="col-6 mb-3 supplier">
            <label for="">{{$lang->write('Supplier')}} :</label>
          ...
          <div class="col-4 mb-3">
            ...
            <input type="number" data-name="cost" class='form-control inp req' min="0">
          </div>

          <div class="col-4 mb-3">
            <label for="">{{$lang->write('Price for client')}} $ :</label>
            <input type="number" data-name="client_price" class='form-control inp req' min="0">
          </div>

          <div class="col-4 mb-3">
            <label for="">{{$lang->write('Commission')}} $ :</label>
            <input type="number" data-name="commission" class='form-control inp req' min="0">
          </div>
