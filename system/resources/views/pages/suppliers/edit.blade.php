    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="mb-3 col-12">
            <label for="">{{$lang->write('Sky / Sea')}} : *</label>
            <select class="form-select inp req" data-name='sky_sea'>
              <option value="">{{$lang->write('Select')}}</option>
              <option {{$get->sky_sea === 'sea' ? 'selected' : ''}} value="sea">{{$lang->write('Sea')}}</option>
              <option {{$get->sky_sea === 'sky' ? 'selected' : ''}} value="sky">{{$lang->write('Sky')}}</option>
            </select>
          </div>
        </div>
      </div>
