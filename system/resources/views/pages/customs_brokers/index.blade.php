...
@include('pages.customs_brokers.new')
@include('pages.customs_brokers.deposit')
@include('pages.customs_brokers.reports')
...
<div class="page-header">
    <div>
        ...
        <div class="page-subtitle">
            {{ $lang->write('Customs brokers and clearance accounts') }}
        </div>
    </div>
