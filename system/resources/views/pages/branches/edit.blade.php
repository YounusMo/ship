  ...
  <div class="modal-dialog modal-dialog-centered modal-md">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="mb-3">
          <label for="">{{$lang->write('Name AR')}} :</label>
          <input type="text" class="form-control inp req" data-name='name' value="{{$get->name}}">
        </div>
        <div class="mb-3">
          <label for="">{{$lang->write('Name EN')}} :</label>
          <input type="text" class="form-control inp req" data-name='name_en' value="{{$get->name_en}}">
        </div>
        <div class="mb-3">
          <label for="">{{$lang->write('Name ZH')}} :</label>
          <input type="text" class="form-control inp req" data-name='name_zh' value="{{$get->name_zh}}">
        </div>
      </div>
