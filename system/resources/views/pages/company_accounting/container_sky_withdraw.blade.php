@php
  ...
  $containers_sky = Cache::remember('containers_sky', env("CACHE"), function () {
...
@endphp
<div class="modal fade" id="sky_withdraw" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
  <div class="modal-dialog modal-dialog-centered modal-md">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="mb-3 container_selector">
          <label for="">{{$lang->write('Trip number')}} :</label>
          {!! $dataController->sys_selector('container',$containers_sky) !!}
        </div>
        ...
        <div class="mb-3 branch_selector">
          ...
          <select class="inp req form-select" data-name="purpose">
            ...
            @foreach ($sky_purpose as $key => $item)
              @if (! in_array($key , ['export_port_customs_fee','import_port_customs_fee','container_fee_value']))  
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary sky_withdraw_btn" onclick="complete_sky_withdraw()">{{$lang->write('Complete')}}</button>
      </div>
    </div>
  </div>
</div>
