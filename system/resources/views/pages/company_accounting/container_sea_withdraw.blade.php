@php
  ...
  $containers_sea = Cache::remember('containers_sea', env("CACHE"), function () {
    return DB::table('containers_sea')
  ...
  <div class="modal-dialog modal-dialog-centered modal-md">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">{{$lang->write('Container withdrawal fees')}}</h5>
      ...
      <div class="modal-body">
        ...
        <div class="mb-3 container_selector">
          ...
          {!! $dataController->sys_selector('container',$containers_sea) !!}
        </div>
        ...
        <div class="mb-3 branch_selector">
          ...
          <select class="inp req form-select" data-name="purpose">
            <option value="">{{$lang->write('Select')}}</option>
            @foreach ($sea_purpose as $key => $item)
