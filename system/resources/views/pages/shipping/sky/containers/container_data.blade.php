...
@extends('layout')
@section('content')
@include('pages.shipping.sky.containers.container_data_modal')
@include('pages.shipping.sky.containers.payment')
...
<div style="width:100%; overflow:scroll" class="container_data">
    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th>{{$lang->write('Arrival Airport')}}</th>
    ...
    @php
        $third = ceil(count($sky_purpose) / 3);
        $first_half  = array_slice($sky_purpose, 0, $third, true);
        $second_half = array_slice($sky_purpose, $third, $third, true);
        $third_half  = array_slice($sky_purpose, $third * 2, null, true);
    @endphp
