      ...
      <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-3 mb-3">
                ...
                <input type="number" class="form-control inp req money" data-name="price">
            </div>
            <div class="col-3 mb-3">
                <label for="">{{$lang->write('Additional cost')}} :</label>
                <input type="number" class="form-control inp money" data-name="plus">
            </div>
            <div class="col-3 mb-3">
                <label for="">{{$lang->write('New total cost')}} :</label>
                <input type="number" class="form-control inp money" data-name="new_price">
            </div>
            <div class="col-3 mb-3">
