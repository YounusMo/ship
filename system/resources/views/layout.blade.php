@php
   ...
   $lng = 'en';
    ...
    if (Auth::guard('web')->check()) {
        $lng = Auth::guard('web')->user()->lang;
        $dir = $lng === 'ar' ? 'rtl' : 'ltr';
    } elseif (Auth::guard('client')->check()) {
        $lng = Auth::guard('client')->user()->lang;
        $dir = $lng === 'ar' ? 'rtl' : 'ltr';
    }
...
<head>
    ...
    {{-- Libraries --}}
    @if ($dir === 'rtl')
        <link rel="stylesheet" href="{{asset('libraries/bootstrap/bootstrap.min.rtl.css')}}?ver={{env('VERSION')}}">
    @else
        <link rel="stylesheet" href="{{asset('libraries/bootstrap/bootstrap.min.css')}}?ver={{env('VERSION')}}">
    @endif

    <link rel="stylesheet" href="{{asset('libraries/printjs/print.css')}}?ver={{env('VERSION')}}">
    ...
    <script src="{{asset('./libraries/jquery/jquery.min.js')}}?ver={{env('VERSION')}}"></script>
    <script src="{{asset('./libraries/sweetalert/sweetalert.min.js')}}?ver={{env('VERSION')}}"></script>
    <script src="{{asset('./libraries/bootstrap/bootstrap.min.js')}}?ver={{env('VERSION')}}"></script>
</head>
<body>
    ...
    <div class="wrapper">
        @if (Auth::guard('web')->check())
            ...
            @if(auth()->user()->type === 'admin')
                @if (auth()->user()->updated_exchange !== date('Y-m-d'))
                    @include('exchanges')
                    <script>
            ...
            @if (in_array(auth()->user()->type,['office_work']))
                @include('components.sidebar.sidebar_office_work')
            @endif
        ...
        @if (Auth::guard('client')->check())
            ...
            {{-- @include('components.navbar_client')
    ...
    <script src="{{asset('./libraries/printjs/print.js')}}?ver={{env('VERSION')}}"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.lazy/1.7.11/jquery.lazy.min.js"></script>

    <script src="{{asset('./js/main.js')}}?ver={{env('VERSION')}}"></script>
    <script src="{{asset('./js/sys_selector.js')}}?ver={{env('VERSION')}}"></script>
    
    
    @if (Auth::guard('client')->check())
        @if ($section === 'sea')
            <script src="{{asset('./js')}}/sea/client/vars.js?ver={{env('VERSION')}}"></script>  
            <script src="{{asset('./js')}}/sea/client/containers.js?ver={{env('VERSION')}}"></script>    
            <script src="{{asset('./js')}}/sea/client/container.js?ver={{env('VERSION')}}"></script>     
        @endif
        @if ($section === 'sky')
            <script src="{{asset('./js')}}/sky/client/vars.js?ver={{env('VERSION')}}"></script>  
            <script src="{{asset('./js')}}/sky/client/containers.js?ver={{env('VERSION')}}"></script>    
            <script src="{{asset('./js')}}/sky/client/container.js?ver={{env('VERSION')}}"></script>     
        @endif
    @endif

    @if (Auth::guard('web')->check())
        @if ($section === 'sea')
            <script src="{{asset('./js')}}/sea/vars.js?ver={{env('VERSION')}}"></script>    
            <script src="{{asset('./js')}}/sea/inside.js?ver={{env('VERSION')}}"></script>    
            <script src="{{asset('./js')}}/sea/outside.js?ver={{env('VERSION')}}"></script>    
            <script src="{{asset('./js')}}/sea/received.js?ver={{env('VERSION')}}"></script>    
            <script src="{{asset('./js')}}/sea/containers.js?ver={{env('VERSION')}}"></script>    
            <script src="{{asset('./js')}}/sea/container.js?ver={{env('VERSION')}}"></script>    
            <script src="{{asset('./js')}}/sea/canceled.js?ver={{env('VERSION')}}"></script>    
            <script src="{{asset('./js')}}/sea/start.js?ver={{env('VERSION')}}"></script>    
        @endif
        
        @if ($section === 'sky')
            <script src="{{asset('./js')}}/sky/vars.js?ver={{env('VERSION')}}"></script>    
            <script src="{{asset('./js')}}/sky/inside.js?ver={{env('VERSION')}}"></script>    
            <script src="{{asset('./js')}}/sky/outside.js?ver={{env('VERSION')}}"></script>    
            <script src="{{asset('./js')}}/sky/received.js?ver={{env('VERSION')}}"></script>    
            <script src="{{asset('./js')}}/sky/containers.js?ver={{env('VERSION')}}"></script>    
            <script src="{{asset('./js')}}/sky/container.js?ver={{env('VERSION')}}"></script>    
            <script src="{{asset('./js')}}/sky/canceled.js?ver={{env('VERSION')}}"></script>    
            <script src="{{asset('./js')}}/sky/start.js?ver={{env('VERSION')}}"></script>    
        @endif
    @endif

    @if (!in_array($section,['sea','sky']))
