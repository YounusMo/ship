...
<div class="card-body mx-auto" style="background: white;margin-top:10vh;border-radius:20px;overflow:hidden">
    <div class="row">
            ...
            <form action="{{url('auth/user/login')}}" method="post">
                ...
                <div class="w-75 mx-auto mt-5">
                    ...
                    <div class="input-group mb-4">
                        ...
                        <input type="text" class="form-control" name="identifier" placeholder="{{$lang->write('Email or code',$selected_lang)}}">
                    </div>
                    ...
                    <div class="input-group mb-4">
                        ...
                        <input type="text" class="form-control" name="password" placeholder="{{$lang->write('Password',$selected_lang)}}">
                    </div>
